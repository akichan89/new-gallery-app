...
export default class PartGrid extends Component {
    ...
    componentDidMount = async() => {
        ...
        const bucket = api.bucket({
         slug: process.env.REACT_APP_COSMIC_BUCKET || '5f62273339323500083b7908',
         read_key: process.env.REACT_APP_COSMIC_READ_KEY || 'NCuztFCQ6PV8PQZaqI6yiNL277aGCSje6lLs6IPqrstlbb2QUj'
        })
